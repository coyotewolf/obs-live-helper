...
const LRCLIB_REQUEST_INTERVAL_MS = Number(process.env.LRCLIB_REQUEST_INTERVAL_MS || 900);
const LRCLIB_PREFETCH_TRACK_INTERVAL_MS = Number(process.env.LRCLIB_PREFETCH_TRACK_INTERVAL_MS || 2500);
