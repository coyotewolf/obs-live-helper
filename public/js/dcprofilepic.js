...
// This is intentionally a local URL. Do not point the iframe directly to
// streamkit.discord.com; StreamKit often refuses direct third-party iframe use.
iframe.src = `/api/discord-profile/streamkit?${proxyParams.toString()}`;
